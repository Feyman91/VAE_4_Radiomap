...
def train(num_epochs, train_precoder):
    if train_precoder:
        ...
        f = open("./logs/training_vae_precoder_beta{}_epoch{}_latent_dim{}_lr{}.txt".format(beta, num_epoch,
                                                                                            latent_dim_precoder,
                                                                                            learning_rate), "w")
        ...
        f = open("./logs/training_vae_channel_beta{}_epoch{}_latent_dim{}_lr{}.txt".format(beta, num_epoch, latent_dim,
                                                                                           learning_rate), "w")
        input_d = input_dim
